...
class Drone extends Bee {
    ...
    public function __construct() {
        $this->lifePoint = $_SESSION[AppConfig::getAppName()][get_class($this)]['lifePoint'] ?? 50;
        $this->hitPoint = $_SESSION[AppConfig::getAppName()][get_class($this)]['hitPoint'] ?? 12;
        $this->noOfBees = $_SESSION[AppConfig::getAppName()][get_class($this)]['noOfBees'] ?? 8;
